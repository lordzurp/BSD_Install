...
cd /mnt
tar xvJpf /mnt/tmp/freebsd-dist/base.txz
tar xvJpf /mnt/tmp/freebsd-dist/lib32.txz
tar xvJpf /mnt/tmp/freebsd-dist/kernel.txz
tar xvJpf /mnt/tmp/freebsd-dist/ports.txz
tar xvJpf /mnt/tmp/freebsd-dist/src.txz
